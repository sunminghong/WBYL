 ...
 * Filename: user_fanslist.view.php
...
$tabdescription=array(
	"position"=>"bottom",
	"html"=>"听众<span class=\"bold\">".$unum."</span>人"	
);
$emptydescription = "<div style=\"text-indent:10px;margin-top:12px;font-size:14px;\">".($user["fansnum"] > 0 ?"暂时没有相关数据":"暂时还没有人收听你")."</div>";
