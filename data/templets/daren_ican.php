...
<tr>
<td style="height:300px;" valign="top" style="postion:relative; "><div id="test_main">
		<table style="margin: 0 auto;height:200px;">
		<caption id="test_cap" style="text-align:left;font-size: 24px;color: #0071BC;font-family:'微软雅黑','黑体';padding-right:30px;"><span class="testlist">1/15</span>　下列不属于中国五大河的是下列不属于中国五大河的是下列不属于中国五大河的是：</caption>
								<tbody><tr>
									<td><div id="answer1" class="clickable answer-box" style="opacity: 1; ">A. 珠模压棋塔顶地苛大法师夺江</div></td>
									<td><div id="answer2" class="answer-box clickable" style="opacity: 1; " correct="true">B. 人民共和国大在在在在在在在</div></td>
								</tr>
								<tr>
									<td><div id="answer3" class="answer-box clickable" style="opacity: 1; ">C. 珠江中华人民共和国大在在在在在在在</div></td>
									<td><div id="answer4" class="answer-box clickable" style="opacity: 1; ">D. 珠江中华顶替枯在在在在</div></td>
								</tr>
								<tr>
									<td><div id="answer5" class="clickable answer-box" style="opacity: 1; ">E. 珠奇才顶替苛栽植模压 </div></td>
...
<td style="width:160px;text-align:center;" valign="middle">
<!--<div id="face2"></div>-->
<div id="div_score" style="font-size:24px;margin:30px 2px;">总分：999</div>
<div id="div_score" style="font-size:24px;margin:30px 2px;">总用时：12:01</div>
<div>本题倒计时：</div>
<div id="div__clock" style="background:url(<?=$templatepath?>/daren_images/clock_block.png?t=33ddd)  0 0 no-repeat; width:141px;height:141px;margin:5px"></div>
</td>
</tr>
</table>
