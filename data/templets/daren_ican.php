...
<? } elseif($op == 'ican') { ?>
<div id="face2"></div><div id="div_score">000</div>
<table cellspacing="0" cellpadding="0" class="formtable" id="test_tr2">
<caption id="test_cap"></caption>
<tr><td style="height:300px;" valign="top" style="postion:relative; "><div id="test_main">
		<table style="margin: 0 auto;height:200px;">
								<tbody><tr>
									<td style="padding: 2px 10px 2px 10px;"><div id="answer1" class="clickable answer-box" style="opacity: 1; ">three, 3</div></td>
									<td style="padding: 2px 10px 2px 10px;"><div id="answer2" class="answer-box clickable" style="opacity: 1; " correct="true">I, me</div></td>
								</tr>
								<tr>
									<td style="padding: 2px 10px 2px 10px;"><div id="answer3" class="answer-box clickable" style="opacity: 1; ">extremely, extraordinary, very</div></td>
									<td style="padding: 2px 10px 2px 10px;"><div id="answer4" class="answer-box clickable" style="opacity: 1; ">how about</div></td>
								</tr>
								<tr>
									<td style="padding: 2px 10px 2px 10px;"><div id="none-button" class="clickable answer-box" style="opacity: 1; ">None of these</div></td>
									<td style="padding: 2px 10px 2px 10px;"><div class="clickable dont-know-button" style="text-align: center; border-top-color: rgb(194, 194, 194); border-right-color: rgb(194, 194, 194); border-bottom-color: rgb(194, 194, 194); border-left-color: rgb(194, 194, 194); color: rgb(194, 194, 194); "><img id="dont-know-choose-img" src="http://static.lingt.com/img/dont-know-button.png" style=""></div></td>
								</tr>
							</tbody></table>


</div><div id="div__clock" style="postion:absolute; right:30px;bottom:40px; width:160px;height:160px;"></div></td></tr>
</table>
