...
<br/><br/>
		...
		<a id="div_follow" href="javascript:follow(0);" wb_screen_name="孙铭鸿"><img src="<?=$templatepath?>/q_images/btn_follow_blue.gif" alt="关注官方微博" ></a> <a href="?app=eq&op=stats"><img src="<?=$templatepath?>/q_images/btn_stats.gif" alt="聪明排行榜" ></a>
			</div>
...
<? foreach((array)$mingrenlist as $top) {?>
						<div style="height:45px; overflow:hidden; margin:5px 5px;">
							...
							<img style="height:45px;" src="<?=$top['avatar']?>"/><img style="height:45px;" src="<?=$urlbase?>images/zhengshu_eq_ico_<?=$top['eqlv']?>.png" class="icoview" params="eq:<?=$top['eqlv']?>:<?=$top['uid']?>" alt="点击查看证书"/>
						</div>
...
<br/><br/>
		<a href="javascript:void();" onclick="javascript:sendStats();"><img src="<?=$templatepath?>/q_images/btn_tweettop.gif" alt="发到微博瞻仰一下"/></a>
					<a id="div_follow" href="javascript:void(0)" onclick="follow(0);" wb_screen_name="孙铭鸿"><img src="<?=$templatepath?>/q_images/btn_follow_blue.gif" alt="关注官方微博"></a>
