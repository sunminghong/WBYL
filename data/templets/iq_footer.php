...
<br/>
<? if($op == 'showscore' || $op=='stats') { ?>	
<!-- 请置于所有广告位代码之前 -->
<script type="text/javascript" src="http://cbjs.baidu.com/js/m.js"></script>
  <!-- 请置于head代码和body代码之间  -->
<script type="text/javascript">
BAIDU_CLB_addSlot("176630");
BAIDU_CLB_enableAllSlots();
BAIDU_CLB_preloadSlots("176630");
</script>

  <!-- 广告位：看看 -->
<script type="text/javascript">BAIDU_CLB_fillSlot("176630");</script>
<? } ?>
...
<div id="zhengshupreview" style="display:none;position:absolute;left:100px;top:100px;width:400px;padding:10px 0 15px;text-align:center; background:#fff; border:10px solid #888;" >
	<img id="zhengshuPic" src="<?=$urlbase?>images/zhengshu_iq_1.png" />
