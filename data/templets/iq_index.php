...
<body>
<div id="topnav"><? if(is_array($account) ) { ?>
<?=$account['screen_name']?>,粉丝：<?=$account['followers']?>,关注：<?=$account['followings']?>  
<a href="?act=account&op=logout">退出</a> 
<? } else { ?>
<? } ?>
</div>
	<div class="mainFrame">
		...
		<div class="ui-widget">
			...
			<div class="login">
				<a href="?act=account&op=tologin" border="0"><img src="<?=$templatepath?>/images/login.png" alt="用微博帐号登录" /></a>
			</div>
		...
		<div class="contentFrame">
			<div class="ui-widget" style="text-align:center; color:#696a62;">
				...
				<div class="welcomeDiv1">
					微博IQ测试应用在这些重要时刻来临前提醒您，让您轻松把握自己的微博生涯关键点。
				</div>

				<div class="welcomeDiv1">
					欢迎关注<a href="http://t.sina.com.cn/5d13" target="_blank">@微博IQ测试官方微博</a>
				</div>
			</div>
		</div>
		<div class="div_login">
...
<? } ?>
		...
		<div class="bottom">
			...
			<div>
	   			<img src="<?=$templatepath?>/images/poweredby.png" alt="由 Sina App Engine 提供支持" />
	   		</div>
	    </div>
	</div>
	<div id=alertdialog title="提示"><P></P></div>
