    ...
    <p><b><input type="hidden" name="usetime"> </b></p></blockquote>
        <dl><dt><span class="px14bx">第1-8 题：请从理论上或逻辑的角度在后面的空格中填入后续字母或数字；</span> 
			<dd>
                ...
                </li><li>21, 20, 18, 15, 11<b> <input size="5" name="q4"> </b>
                </li><li>8, 6, 7, 5, 6, 4<b> <input size="5" name="q5"> </b>
                </li><li>65536, 256, 16<b> <input size="5" name="q6"> </b>
                </li><li>1, 0, -1, 0<b> <input size="5" name="q7"> </b>
                </li><li>3968, 63, 8, 3<b> <input size="5" name="q8"> 
          </b></li></ol>
		</dd>
	 </dl>
...
<input name="q25" type="radio" value="d"> D</b> </li>
          ...
          <dl>
              <dt><span class="px14bx">第26-29 题：四个图形中缺少两个图形，请选择一组图形(a b c d e)中选出两个填入空缺的方格以使下列图形从逻辑角度上能成双配对</span></dt>
            <dd>
				<ol>
                <li>(第26题)<br>
                  ...
                  a 
                  <input type="checkbox" value="b" name="q26">
                  b 
                  <input type="checkbox" value="c" name="q26">
                  c 
                  <input type="checkbox" value="d" name="q26">
                  d 
                  <input type="checkbox" value="e" name="q26">
                  e</b><br>
                  <br>
                </li><li>(第27题)<br>
                  ...
                  a 
                  <input type="checkbox" value="b" name="q27">
                  b 
                  <input type="checkbox" value="c" name="q27">
                  c 
                  <input type="checkbox" value="d" name="q27">
                  d 
                  <input type="checkbox" value="e" name="q27">
                  e</b><br>
                  <br>
                </li><li>(第28题)<br>
                  ...
                  a 
                  <input type="checkbox" value="b" name="q28">
                  b 
                  <input type="checkbox" value="c" name="q28">
                  c 
                  <input type="checkbox" value="d" name="q28">
                  d 
                  <input type="checkbox" value="e" name="q28">
                  e</b><br>
                  <br>
                </li><li>(第29题)<br>
				  ...
				  a 
                  <input type="checkbox" value="b" name="q29">
                  b 
                  <input type="checkbox" value="c" name="q29">
                  c 
                  <input type="checkbox" value="d" name="q29">
                  d 
                  <input type="checkbox" value="e" name="q29">
                  e</b><br>
                  <br>
              </li></ol>
            </dd>
          ...
          <dl> 
              <dt><span class="px14bx">第30-33 题：在下列题目中每一行都缺少一个图，请选择一个(a b c d)插入空缺方格中以使左边的图形逻辑角度上能成双配对</span></dt>
			  <dd> 
              <ol>
                <li>(第30题)<br>
                  ...
                  b 
                  <input type="radio" value="c" name="q30">
                  c 
                  <input type="radio" value="d" name="q30">
                  d</b> <br>
                  <br>
                </li><li>(第31题)<br>
                  ...
                  b 
                  <input type="radio" value="c" name="q31">
                  c 
                  <input type="radio" value="d" name="q31">
                  d</b> <br>
                  <br>
                </li><li>(第32题)<br>
                  ...
                  b 
                  <input type="radio" value="c" name="q32">
                  c 
                  <input type="radio" value="d" name="q32">
                  d</b> <br>
                  <br>
                </li><li>(第33题)<br>
                  ...
                  b 
                  <input type="radio" value="c" name="q33">
                  c 
                  <input type="radio" value="d" name="q33">
                  d</b> <br>
                      <br>
              </li></ol>			  
            </dd>
