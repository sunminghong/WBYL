...
<link href="<?=$templatepath?>image/public.css" rel="stylesheet" type="text/css" />
<link href="<?=$templatepath?>image/secretlove/css.css" rel="stylesheet" type="text/css" />
<script src="<?=$templatepath?>image/jquery.min.js"></script>
<script src="<?=$templatepath?>image/public.js"></script>
<script src="<?=$templatepath?>image/secretlove/js.js"></script>
<!--[if IE 6]>
<script type="text/javascript" src="<?=$templatepath?>image/secretlove/pngfix.js"></script>
<style type="text/css">.pngfix{behavior: url("<?=$templatepath?>image/secretlove/iepngfix.htc");}</style>
<![endif]-->
</head>
<body>
...
<div id="content" class="tips-box" style="height:355px; overflow:hidden">
	...
	<div class="info tips-box">
   	  <img class="myhead" src="<?=$account['head']?>/100" />
	  <div class="intr">
        <p class="p"><a target="_blank" href="http://www.weibo.com/<?=$account['user']?>"><?=$account['name']?>(@<?php echo <?=$myinfo['data']['name']?>?>)</a>，如果你暗恋某个人，可以在这里悄悄告诉我，如果你暗恋的人正好暗恋你，系统就会发私信告诉你们俩啦~</p>
	...
	<div class="zhuanbo">
    	<textarea name="zhuanbocontent" id="zhuanbocontent">/害羞 嘿，我在暗恋你，会不会刚好你也恋着我？#我在暗恋你# 你们也来试试吧？<?=$urlbase?>?app=secretlove</textarea>
