...
<div class="bottom" id="footer1">
	<span>Copy &copy; 2011 看看你有多聪明 版权所有 - Developed By @一挥
		<a href="http://t.qq.com/yihuiso" target="_blank">一挥</a>　
...
<div id="zhengshupreview" style="display:none;position:absolute;left:100px;top:100px;width:400px;padding:10px 0 15px;text-align:center; background:#fff; border:10px solid #888;" >
	<img id="zhengshuPic" src="<?=$urlbase?>images/zhengshu_eq_1.png" />
		<a href="javascript:void(0);" id="btn_send_2"><img src="<?=$templatepath?>/q_images/btn_tweet.gif"/></a> 
</div>
