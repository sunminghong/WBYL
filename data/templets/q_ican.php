...
<form name="quest" method="post" action="?app=eq&op=cacl" id="quest_form" onsubmit="return calculate();">
...
<div id="quest_append" style="margin:30px 0 0 30px;"></div>
	<div class="field" style="margin:20px;padding-left:20px;">
			<p>
							<a href="#" onclick="javascript:calculate();" ><img src="<?=$templatepath?>/q_images/btn_showscore_<?=$app?>.gif" alt="查看我的分数"/></a></p>
	</div>
</form>
