...
<div class="contentFrame">
			<div class="ui-widget" style="text-align:center; color:#696a62;">
				<div class="welcomeDiv1" id="top_list1" style="text-align:left;">				
					<b><? echo strtoupper($app);?>数据统计</b>：总登录人数 <b><?=$eqCount['totalUser']?></b>，成功测试人数 <b><?=$eqCount['eqs']?></b>人， 有效测试  <b><?=$eqCount['logs']?></b>次。目前@<?=$eqCount['maxName']?> 以  <b><?=$eqCount['maxEq']?></b>分的惊人成绩 排名第一！希望聪明的你可以创造奇迹超越 TA！ 
<br/><br/>
