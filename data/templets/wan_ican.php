...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<link type="text/css" rel="stylesheet" href="<?=$templatepath?>/wan_images/wan.css" />
...
<script type="text/javascript" src="<?=$templatepath?>/wan_images/wan.js?v=1.0"></script>
<? } ?>
<? if($op == 'showscore') { ?>
...
<? if($op=="ready") { ?>
				...
				<tr>
				<th style="width:12em;"><a href="?app=iq&act=wan&op=ican"><img src="<?=$templatepath?>/iq_images/btn_ready.gif" alt="我准备好了，开始" /></a></th>
