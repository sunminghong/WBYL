...
//	}
	...
	function public_timeline( $count = 20 )
	{
		...
		return $this->oauth->get($this->host.'statuses/public_timeline.json', $params);
	}
	...
	function mentions( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/mentions.json' , $page , $count, $params );
	}
	...
	function get_status_url( $sid, $uid = NULL )
	{
		...
		return $this->host."$uid/statuses/$sid";
	}
	...
	function update_remark( $uid, $remark )
	{
		...
		return $this->oauth->post( $this->host.'user/friends/update_remark.json' , $params );
	}
	...
	function emotions( $type = "face", $language = "cnname" )
	{
		...
		return $this->oauth->get( $this->host.'emotions.json' , $params );
	}
	...
	function reset_count( $type )
	{
		...
		return $this->oauth->get( $this->host.'statuses/reset_count.json' , $params );
	}
	...
	function user_timeline( $page = 1 , $count = 20 , $uid_or_name = NULL , $since_id = NULL, $max_id = NULL)
	{
		...
		return $this->request_with_uid( $this->host.'statuses/user_timeline.json' ,  $uid_or_name , $page , $count , NULL , true, $params );
	}
	...
	function list_dm( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'direct_messages.json' , $page , $count, $params );
	}
	...
	function list_dm_sent( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'direct_messages/sent.json' , $page , $count, $params );
	}
	...
	function send_dm( $uid_or_name , $text )
	{
		...
		return $this->oauth->post( $this->host.'direct_messages/new.json' , $params  );
	}
	...
	function delete_dms( $dids )
	{
		...
		return $this->oauth->post( $this->host.'direct_messages/destroy_batch.json' , $params );
	}
	...
	function repost_by_me( $uid, $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/repost_by_me.json' , $page , $count , $params );
	}
	...
	function repost_timeline( $sid, $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/repost_timeline.json' , $page , $count , $params );
	}
	...
	function repost( $sid , $text = NULL, $is_comment = 0 )
	{
		...
		return $this->oauth->post( $this->host.'statuses/repost.json' , $params  );
	}
	...
	function send_comment( $sid , $text , $cid = NULL )
	{
		...
		return $this->oauth->post( $this->host.'statuses/comment.json' , $params  );
	...
	function comment_destroy_batch( $cids )
	{
		...
		return $this->oauth->post( $this->host.'statuses/comment/destroy_batch.json' , $params );
	}
	...
	function unread( $with_new_status = 0, $since_id = NULL )
	{
		...
		return $this->oauth->get( $this->host.'statuses/unread.json' , $params );
	}
	...
	function reply( $sid , $text , $cid )
	{
		...
		return $this->oauth->post( $this->host.'statuses/reply.json' , $params  );
	...
	function get_favorites( $page = NULL )
	{
		...
		return $this->oauth->get( $this->host.'favorites.json', $params );
	}
	...
	{
		$this->id_format($cid);
		return $this->oauth->post( $this->host.'statuses/comment_destroy/' . $cid . '.json' );
	}
	...
	function comments_to_me( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/comments_to_me.json' , $page , $count , $params );
	}
	...
	function comments_by_me( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/comments_by_me.json' , $page , $count , $params );
	}
	...
	function comments_timeline( $page = 1 , $count = 20, $since_id = NULL, $max_id = NULL )
	{
		...
		return $this->request_with_pager( $this->host.'statuses/comments_timeline.json' , $page , $count , $params );
	}
	...
	function get_comments_by_sid( $sid , $page = 1 , $count = 20 )
	{
		...
		return $this->oauth->get($this->host.'statuses/comments.json' , $params );
	...
	function get_count_info_by_ids( $sids )
	{
		...
		return $this->oauth->get( $this->host.'statuses/counts.json' , $params );
	}
	...
	function add_to_favorites( $sid )
	{
		...
		return $this->oauth->post( $this->host.'favorites/create.json' , $params );
	}
	...
	function remove_from_favorites_batch( $fids )
	{
		...
		return $this->oauth->post( $this->host.'favorites/destroy_batch.json' , $params );
	}
	...
	{
		$this->id_format($id);
		return $this->oauth->post( $this->host.'favorites/destroy/' . $id . '.json'  );
	}
	...
	{
		return $this->oauth->get($this->host.'account/rate_limit_status.json');
	}
	...
	{
		return $this->oauth->post($this->host.'account/update_privacy.json', $privacy_settings);
	}
	...
	{
		return $this->oauth->post($this->host.'account/get_privacy.json');
	}
	...
	{
		return $this->oauth->post($this->host.'account/update_profile.json', $profile);
	}
	...
	function provinces()
	{
		return $this->oauth->get($this->host.'provinces.json');
	}
	...
	{
		return $this->request_with_uid( $this->host.'friends/ids.json' ,  $uid_or_name , false , $count , $cursor );
	}
	...
	{
		return $this->request_with_uid( $this->host.'followers/ids.json' ,  $uid_or_name , false , $count , $cursor );
	}
	...
	function add_to_blocks( $user_id = NULL, $screen_name = NULL )
	{
		...
		return $this->oauth->post( $this->host.'blocks/create.json' , $params );
	}
	...
	function remove_from_blocks( $user_id = NULL, $screen_name = NULL )
	{
		...
		return $this->oauth->post( $this->host.'blocks/destroy.json' , $params );
	}
	...
	function in_blocks( $user_id = NULL, $screen_name = NULL )
	{
		...
		return $this->oauth->post( $this->host.'blocks/exists.json' , $params );
	}
	...
	{
		return $this->request_with_pager( $this->host.'blocks/blocking.json' , $page , $count );
	}
	...
	{
		return $this->request_with_pager( $this->host.'blocks/blocking/ids.json' , $page , $count );
	}
	...
	function get_tags( $user_id = NULL, $page = 1, $count = 20 )
	{
		...
		return $this->request_with_pager( $this->host.'tags.json' , $page , $count , $params );
	}
	...
	function add_tags( $tags )
	{
		...
		return $this->oauth->post( $this->host.'tags/create.json' , $params );
	}
	...
	{
		return $this->request_with_pager( $this->host.'tags/suggestions.json' , $page , $count );
	}
	...
	function delete_tag( $tag_id )
	{
		...
		return $this->oauth->post( $this->host.'tags/destroy.json' , $params );
	}
	...
	function delete_tags( $ids )
	{
		...
		return $this->oauth->post( $this->host.'tags/destroy_batch.json' , $params );
	}
	...
	function get_trends( $user_id = NULL, $page = 1, $count = 20 )
	{
		...
		$this->id_format($params['user_id']);
		return $this->request_with_pager( $this->host.'trends.json' , $page , $count , $params );
	}
	...
	function trends_timeline( $trend_name )
	{
		...
		return $this->oauth->get( $this->host.'trends/statuses.json' , $params );
	}
	...
	function follow_trends( $trend_name )
	{
		...
		return $this->oauth->post( $this->host.'trends/follow.json' , $params );
	}
	...
	function unfollow_trends( $tid )
	{
		...
		return $this->oauth->delete( $this->host.'trends/destroy.json' , $params );
	}
	...
	function hourly_trends( $base_app = 1 )
	{
		...
		return $this->oauth->get( $this->host.'trends/hourly.json' , $params );
	}
	...
	function daily_trends( $base_app = 1 )
	{
		...
		return $this->oauth->get( $this->host.'trends/daily.json' , $params );
	}
	...
	function weekly_trends( $base_app = 1 )
	{
		...
		return $this->oauth->get( $this->host.'trends/weekly.json' , $params );
	}
