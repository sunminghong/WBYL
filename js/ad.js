    ...
    function S(w,a,sr){
        if(w.u_a_type=="1"){
            a.write('<script language="JavaScript1.1" src='+s(sr)+" charset=gbk><\/script>")
				...
				var aaaa= a.getElementById(addiv);
				if(aaaa)aaaa.innerHTML='<iframe name="u_a_iframe" width='+s(w.u_a_width)+" height="+s(w.u_a_height)+" frameborder=0 src="+s(sr)+' marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no"></iframe>';
        }
    }
    function A(){
        ...
        w.u_a_url="http://www.17g.net/show.php?";
